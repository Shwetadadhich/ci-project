        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle img-round" src="<?php echo base_url(); ?>assests/DataTables/images/<?php echo $_SESSION['image']; ?>" alt="User profile picture">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                M.SC(CS) in Computer Science from the University of Aishwariya College
              </p>
              ...
              <p class="text-muted">Sardarpura Jodhpur</p>
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?php echo base_url(); ?>assests/theme/dist/img/user1-128x128.jpg" alt="user image">
                        <span class="username">
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?php echo base_url(); ?>assests/theme/dist/img/user7-128x128.jpg" alt="User Image">
                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?php echo base_url(); ?>assests/theme/dist/img/user6-128x128.jpg" alt="User Image">
                        <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                  ...
                  <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img class="img-responsive" src="<?php echo base_url(); ?>assests/theme/dist/img/photo1.png" alt="Photo">
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="<?php echo base_url(); ?>assests/theme/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="<?php echo base_url(); ?>assests/theme/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img class="img-responsive" src="<?php echo base_url(); ?>assests/theme/dist/img/photo4.jpg" alt="Photo">
                          <br>
                          <img class="img-responsive" src="<?php echo base_url() ?>assests/theme/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
...
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo base_url(); ?>asssests/theme/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- FastClick -->
