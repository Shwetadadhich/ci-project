			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h2 class="bread"><span><a href="<?php echo base_url("Estore"); ?>">Home</a></span> <span><a href="<?php echo base_url("Estore/product_shop"); ?>">Product</a></span> <span>Product Detail</span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
				...
				<div class="row row-pb-lg">
					<div class="col-md-10 col-md-offset-1">
						<div class="product-detail-wrap">
							<div class="row">
							<?php if (!empty($get_oneproduct) && isset($get_oneproduct)) {?>
							    <div class="col-md-5">
									<div class="product-entry">
										<div class="product-img" style="background-image: url(<?php echo base_url('assests/DataTables/images/'.$get_oneproduct->image); ?> ">
											<p class="tag"><span class="sale">Sale</span></p>
										</div>
										<div class="thumb-nail">
											<a href="#" class="thumb-img" style="background-image: url(<?php echo base_url('assests/DataTables/images/'.$get_oneproduct->image); ?>"></a>
											<a href="#" class="thumb-img" style="background-image: url(<?php echo base_url('assests/DataTables/images/'.$get_oneproduct->image); ?>"></a>
											<a href="#" class="thumb-img" style="background-image: url(<?php echo base_url('assests/DataTables/images/'.$get_oneproduct->image); ?>"></a>
										</div>
									</div>	
								...
								<div class="col-md-7">
									<div class="desc">
										<h3><?= $get_oneproduct->title; ?></h3>
										<p class="price">
											<span>$<?php echo $get_oneproduct->price; ?></span> 
										...
										<p><?php echo $get_oneproduct->description; ?></p>
								   ...
								   <div id="review" class="tab-pane fade">
								   	<div class="row">
								   		<div class="col-md-7">
										   	...
										   	<div class="review">
										   		<div class="user-img" style="background-image: url('<?php echo base_url("assests/store/images/person2.jpg"); ?>')"></div>
										   		<div class="desc">
										   			<h4>
										   				<span class="text-left">Jacob Webb</span>
										   				<span class="text-right">14 March 2018</span>
										   	...
										   	<div class="review">
										   		<div class="user-img" style="background-image: url('<?php echo base_url("assests/store/images/person3.jpg"); ?>')"></div>
										   		<div class="desc">
										   			<h4>
										   				<span class="text-left">Jacob Webb</span>
										   				<span class="text-right">14 March 2018</span>
